...
class Scrutiny_model extends CI_Model{
	...
	function get_scrutiny_pen_complaints($role_id){  
		$this->db->select('C.ref_no, C.sur_name, C.mid_name, C.first_name, C.dt_of_filing, S.filing_no, S.scrutiny_status,S.defective, S.objections,S.is_repeated');
		$this->db->distinct();
